...
interface = r"""run.cmd {delimiter} {script} {inputfilename} {outputfilename} """  
...
def awk(
    script: InputFile(type=(['AnyDirectory', 'AnyFile'])),
    inputfilename: InputFile(type=(['AnyDirectory', 'AnyFile'])),
    outputfilename: OutputFile(),
    delimiter: str,
):
    input_file_keys = ["script","inputfilename"]
    port_keys = ["script","inputfilename","outputfilename"]
...
if __name__ == '__main__':
    ComponentExecutor(awk).execute(sys.argv)
