...
def train_args():
    ...
    parser.add_argument('--trained-model', type=str, default='debug_out/trained_model/',
                        help='the trained path')
    parser.add_argument('--vocab-path', type=str, default='debug_out/vocab/',
    ...
    parser.add_argument('--label-column', type=str, default='label',
                        help='Select the column that contains the label')
    parser.add_argument('--text-column', type=str, default='text',
                        help='Select the column that contains the Text')
