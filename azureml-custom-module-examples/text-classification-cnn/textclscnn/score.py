...
from textclscnn.args_util import predict_args
...
class Predictor():
    ...
    def scores(self, df_true, df_predict):
        ...
        print(f'true label value counts: {df_true.value_counts()}')
        print(f'pred label value counts: {df_predict.value_counts()}')
